      ...
      <div className={style.home__container}>
              ...
              <form className={style.form}>
                ...
                <p>
                  ...
                  <Link
                    to="/"
                    onClick={toggleAuth}
                    className={style.create__account}
                  >
            ...
            <div className={`${style.form__container} ${style.create}`}>
              <form className={style.form}>
                ...
                <button type="submit" className={style.join__button}>
                  <Link to="/home">Agree and Join</Link>
                </button>
        ...
        <div className={style.description__container}>
          ...
          <p>
            ...
            laborum hic, adipisci vero reiciendis, recusandae sit ad, eum
            quisquam! Molestias, commodi!
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quidem
            voluptate officiis beatae nobis pariatur omnis facere accusamus
          ...
          <p>
            ...
            sunt perferendis dolorum. Praesentium necessitatibus qua consectetur
            sunt tempora simus eveniet voluptates?
          </p>
